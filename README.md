...
Repository Structure data/ Processed abundance tables, taxonomy tables, and environmental datasets used in analyses.

metadata/ Sample metadata and plot level environmental variables. scripts/ R scripts used for statistical analyses, community analyses, and figure generation.

figures/ Output figures associated with the manuscript.

sequence data/ Raw sequencing reads are available through the NCBI Sequence Read Archive (SRA) under accession number: PRJNA1469031
